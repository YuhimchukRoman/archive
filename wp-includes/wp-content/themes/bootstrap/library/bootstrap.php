 ...
 *
 * Includes: Bootstrap Nav Walker, Bootstrap Pagination, Bootstrap Comment Tree
 *
 */
 ...
 *
 * Credits: https://github.com/talentedaamer/Bootstrap-wordpress-pagination
 *
 */
...
/** 
* Bootstrap Comments Tree
*
*/
if ( ! class_exists( 'bootstrap_Comments' ) ) :
class bootstrap_Comments extends Walker_Comment{
	...
	function __construct() { ?>
        ...
        <h3><?php comments_number( __( 'No Responses to', 'bootstrap' ), __( 'One Response to', 'bootstrap' ), __( '% Responses to', 'bootstrap' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<header class="comment-author">
			...
			<?php printf( __( '<cite class="fn">%s</cite>', 'bootstrap' ), get_comment_author_link() ) ?>
			<time datetime="<?php echo comment_date( 'c' ) ?>"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf( __( '%1$s', 'bootstrap' ), get_comment_date(),  get_comment_time() ) ?></a></time>
